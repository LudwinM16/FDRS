...
?>
	...
	<div class="info">
		...
		<div class="datos table-responsive">
		<caption>Listado Usuarios</caption>
        <table class="table table-bordered table-striped  table-hover">
			<thead>
				<tr>
    	            <th scope="col">#</th>
					<th scope="col" colspan="">Nombre <i>(Apellido, Nombre)</i></th>
            ...
            <?php
                ...
                $enlace2 ="<a class=\"text-danger\" onclick=' return confirmar3();' href='../controlador/ctrlCoordinador.php?accion=eliminar&id=";
                foreach($usuarios as $usuario){
                    echo "<tr><th scope=\"row\">". $usuario['idUsuario'] ."</th><td>". $usuario['apellidos'] .", ". $usuario['nombres'] ."</td><td>".$enlace . $usuario['idUsuario'] ."'><i class='fas fa-edit'></i></a></td><td>".$enlace2 . $usuario['idUsuario'] ."'><i class='fas fa-trash-alt'></i></a></td></tr>";
                }
            ?>
			</tbody>
        </table>
